...
- **378+ artifacts, 58 categories** across 4 platforms, fully searchable (⌘K)
- **Dark / light mode**, persisted across visits, respects system preference by default
- **One-tap copy** on every artifact card — copies a clean, formatted text summary
...
- **Ad-slot ready** — a clearly-labeled, dismissible "widget" component (`src/AdWidget.jsx`) is wired into the layout, ready for a non-intrusive ad network of your choice (see comments in that file)
...
src/
  ...
  AdWidget.jsx        Ad slot placeholder (sidebar + content variants)
